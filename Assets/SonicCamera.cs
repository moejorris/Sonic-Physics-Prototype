...
{
    public static SonicCamera instance;
    ...
    void LateUpdate()
    {
        ...
        if(ppCam.enabled) //snapping to pixel grid is currently disabled because perfect pixel is acting strange at the moment.
        {
            // targetPosition = currentPos.SnapToPixel();
