...
public class PlayerMovement : MonoBehaviour
{
    ...
    void GroundedMovement()
    {
        ...
        {
            StartRolling();
            PlaySoundEffect(characterData.sfx.rollSound);
        }
    ...
    bool StartJump(bool useGroundAngle = true)
    {
        ...
        if(wantsJump && canJump)
        {
            ...
            //play sfx
            PlaySoundEffect(characterData.sfx.jumpSound);
    ...
    public void PlaySoundEffect(AudioClip clip, float pitch = 1f)
    {
        if(clip == null)
        {
            Debug.LogWarning($"Failure to play sound effect, null is not a valid clip. No sound effect will be played.");
            return;
        }
